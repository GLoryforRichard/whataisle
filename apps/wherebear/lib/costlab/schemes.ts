...
// Deliberately pinned experiment baseline: Cost Lab compares historical model
// quality/cost and must not drift when the production Vertex default changes.
// OpenRouter model IDs are also upgraded independently from Google's catalog.
...
export const SCHEMES: LabScheme[] = [
  scheme(
    ...
    '历史基准：全程 3.6-flash',
    '固定的历史对照，三个环节都是 gemini-3.6-flash。跑两次取自身一致度作为“噪声底线”。',
    g36(),
    g36(),
    g36()
  ),
