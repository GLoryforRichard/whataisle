 ...
 *  - Flex has an additional 3,000 QPM per-project/per-base-model limit on top
 *    of content-generation quotas, but must NOT share lib/gemini.ts's standard
 *    concurrency gate: minutes-long flex
