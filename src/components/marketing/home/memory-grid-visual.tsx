    ...
    >
      ...
      <div className="grid grid-cols-4 gap-2.5">
        ...
        >
          ...
          <motion.span
            variants={ringVariant}
            className="-top-2 -right-2 absolute whitespace-nowrap rounded-full bg-[var(--brand-accent)] px-1.5 py-0.5 font-bold text-[9px] text-[var(--brand-accent-foreground)] shadow-sm"
          >
            {newBadge}
          </motion.span>
